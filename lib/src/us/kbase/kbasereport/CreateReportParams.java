...
public class CreateReportParams {
    ...
    public CreateReportParams withMessage(java.lang.String message) {
        this.message = message;
        return this;
    }
    ...
    public CreateReportParams withObjectsCreated(List<WorkspaceObject> objectsCreated) {
        this.objectsCreated = objectsCreated;
        return this;
    }
    ...
    public CreateReportParams withWarnings(List<String> warnings) {
        this.warnings = warnings;
        return this;
    }
    ...
    public CreateReportParams withHtmlLinks(List<us.kbase.kbasereport.File> htmlLinks) {
        this.htmlLinks = htmlLinks;
        return this;
    }
    ...
    public CreateReportParams withDirectHtml(java.lang.String directHtml) {
        this.directHtml = directHtml;
        return this;
    }
    ...
    public CreateReportParams withDirectHtmlLinkIndex(Long directHtmlLinkIndex) {
        this.directHtmlLinkIndex = directHtmlLinkIndex;
        return this;
    }
    ...
    public CreateReportParams withFileLinks(List<us.kbase.kbasereport.File> fileLinks) {
        this.fileLinks = fileLinks;
        return this;
    }
    ...
    public CreateReportParams withReportObjectName(java.lang.String reportObjectName) {
        this.reportObjectName = reportObjectName;
        return this;
    }
    ...
    public CreateReportParams withWorkspaceName(java.lang.String workspaceName) {
        this.workspaceName = workspaceName;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((("CreateReportParams"+" [message=")+ message)+", objectsCreated=")+ objectsCreated)+", warnings=")+ warnings)+", htmlLinks=")+ htmlLinks)+", directHtml=")+ directHtml)+", directHtmlLinkIndex=")+ directHtmlLinkIndex)+", fileLinks=")+ fileLinks)+", reportObjectName=")+ reportObjectName)+", workspaceName=")+ workspaceName)+", additionalProperties=")+ additionalProperties)+"]");
    }
