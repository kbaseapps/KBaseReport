...
async_run_methods = {}
async_check_methods = {}
async_run_methods['KBaseReport.create_async'] = ['KBaseReport', 'create']
async_check_methods['KBaseReport.create_check'] = ['KBaseReport', 'create']
sync_methods['KBaseReport.create'] = True
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_KBaseReport.create,
                             ...
                             types=[dict])
        self.method_authentication['KBaseReport.create'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "KBaseReport but no authentication header was passed"
                            raise err
